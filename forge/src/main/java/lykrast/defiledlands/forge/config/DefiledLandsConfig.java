...
public class DefiledLandsConfig {
        ...
        public static void bake() {
                ...
                CorruptionHelper.wyrmConversionRate = COMMON.wyrmConversionRate.get();
        ...
        private static class Common {
                ...
                final ForgeConfigSpec.DoubleValue wyrmConversionRate;
                ...
                Common(ForgeConfigSpec.Builder builder) {
                        ...
                        wyrmConversionRate = builder
                                        .comment(
                                                        "Enchantment conversion rate for Book Wyrms.",
                                                        "Affects both the digest burden when feeding enchanted books and the output budget when producing them.",
                                                        "Higher values mean more digest burden per enchantment and fewer output enchantments.",
                                                        "Default: 1.0.")
                                        .defineInRange("wyrmConversionRate", 1.0, 0.1, 10.0);
