...
public class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(DefiledLands.MOD_ID, Registries.CREATIVE_MODE_TAB);
    ...
    public static void register() {
        ...
        CreativeTabRegistry.append(DEFILED_LANDS_TAB,
            ...
            ModItems.UMBRA_HELMET,
            ModItems.UMBRA_CHESTPLATE,
            ModItems.UMBRA_LEGGINGS,
            ModItems.UMBRA_BOOTS,
